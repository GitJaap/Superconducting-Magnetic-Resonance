# main_window.py, project window for QT lab environment
...
class MainWindow(qtwindow.QTWindow):
    ...
    def __init__(self):
        ...
        qtwindow.QTWindow.__init__(self, 'project', 'QT Lab', add_to_main=False)
...
#        self.menu = gui.build_menu(menu)
    ...
    def add_window(self, win):
        '''Add a button for window 'win' to the project window.'''
